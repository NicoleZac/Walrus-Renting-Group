              ...
              <div>
                <div className="save-1" onClick={closeModal}>
                  ...
                  >
                    ...
                    {isHovered && (
                      <img
                        src={Guide} // Replace with your image URL
                        alt="Hovered Image"
                        style={{
                          position: "absolute",
                          textDecoration: "underline",
                          border: "2px solid #000",
                          top: "-345px", // Adjust the distance from the text
                          left: "-500px", // Center the image horizontally
                          scale: "0.5",
                        }}
                      />
                    )}
        ...
        <div className="overlap-group">
          ...
          <div className="overlap-group-wrapper">
            {Thur1 && (
              <div
                ...
                style={{ height: 37, borderRadius: 0, backgroundColor: BCt1 }}
              >
                {" "}
                <div
                  className="rectanglet1"
            ...
            {Thur2 && (
              <div
                className="overlap-group-2"
                style={{ height: 37, borderRadius: 0, backgroundColor: BCt2 }}
              >
                {" "}
                <div
                  className="rectanglet2"
                  style={{ height: 37, borderRadius: 0 }}
                  onClick={Thur2Click}
                />{" "}
              </div>
            ...
            {Thur3 && (
              <div
                className="overlap-group-2"
                style={{ height: 37, borderRadius: 0, backgroundColor: BCt3 }}
              >
                {" "}
                <div
                  className="rectanglet3"
                  style={{ height: 37, borderRadius: 0 }}
                  onClick={Thur3Click}
                />{" "}
              </div>
            ...
            {Thur4 && (
              <div
                className="overlap-group-2"
                style={{ height: 37, borderRadius: 0, backgroundColor: BCt4 }}
              >
                {" "}
                <div
                  className="rectanglet4"
                  style={{ height: 37, borderRadius: 0 }}
                  onClick={Thur4Click}
                />{" "}
              </div>
            ...
            {Thur5 && (
              <div
                className="overlap-group-2"
                style={{ height: 37, borderRadius: 0, backgroundColor: BCt5 }}
              >
                {" "}
                <div
                  className="rectanglet5"
                  style={{ height: 37, borderRadius: 0 }}
                  onClick={Thur5Click}
                />{" "}
              </div>
            ...
            {Thur6 && (
              <div
                className="overlap-group-2"
                style={{ height: 37, borderRadius: 0, backgroundColor: BCt6 }}
              >
                {" "}
                <div
                  className="rectanglet6"
                  style={{ height: 37, borderRadius: 0 }}
                  onClick={Thur6Click}
                />{" "}
              </div>
          ...
          <div className="overlap-wrapper">
            {Mon1 && (
              <div
                className="overlap-group-2"
                style={{ height: 37, borderRadius: 0, backgroundColor: BCm1 }}
              >
                {" "}
                <div
                  className="rectanglew1"
                  style={{ height: 37, borderRadius: 0 }}
                  onClick={Mon1Click}
                />{" "}
              </div>
            ...
            {Mon2 && (
              <div
                className="overlap-group-2"
                style={{ height: 37, borderRadius: 0, backgroundColor: BCm2 }}
              >
                {" "}
                <div
                  className="rectanglew2"
                  style={{ height: 37, borderRadius: 0 }}
                  onClick={Mon2Click}
                />{" "}
              </div>
            ...
            {Mon3 && (
              <div
                className="overlap-group-2"
                style={{ height: 37, borderRadius: 0, backgroundColor: BCm3 }}
              >
                {" "}
                <div
                  className="rectanglew3"
                  style={{ height: 37, borderRadius: 0 }}
                  onClick={Mon3Click}
                />{" "}
              </div>
            ...
            {Mon4 && (
              <div
                className="overlap-group-2"
                style={{ height: 37, borderRadius: 0, backgroundColor: BCm4 }}
              >
                {" "}
                <div
                  className="rectanglew4"
                  style={{ height: 37, borderRadius: 0 }}
                  onClick={Mon4Click}
                />{" "}
              </div>
            ...
            {Mon5 && (
              <div
                className="overlap-group-2"
                style={{ height: 37, borderRadius: 0, backgroundColor: BCm5 }}
              >
                {" "}
                <div
                  className="rectanglew5"
                  style={{ height: 37, borderRadius: 0 }}
                  onClick={Mon5Click}
                />{" "}
              </div>
            ...
            {Mon6 && (
              <div
                className="overlap-group-2"
                style={{ height: 37, borderRadius: 0, backgroundColor: BCm6 }}
              >
                {" "}
                <div
                  className="rectanglew6"
                  style={{ height: 37, borderRadius: 0 }}
                  onClick={Mon6Click}
                />{" "}
              </div>
          ...
          <div className="div-wrapper">
            {Wed1 && (
              <div
                className="overlap-2"
                style={{ height: 37, borderRadius: 0, backgroundColor: BCw1 }}
              >
                {" "}
                <div
                  className="rectanglew1"
            ...
            {Wed2 && (
              <div
                className="overlap-2"
                style={{ height: 37, borderRadius: 0, backgroundColor: BCw2 }}
              >
                {" "}
                <div
                  className="rectanglew2"
            ...
            {Wed3 && (
              <div
                className="overlap-2"
                style={{ height: 37, borderRadius: 0, backgroundColor: BCw3 }}
              >
                {" "}
                <div
                  className="rectanglew3"
            ...
            {Wed4 && (
              <div
                className="overlap-2"
                style={{ height: 37, borderRadius: 0, backgroundColor: BCw4 }}
              >
                {" "}
                <div
                  className="rectanglew4"
            ...
            {Wed5 && (
              <div
                className="overlap-2"
                style={{ height: 37, borderRadius: 0, backgroundColor: BCw5 }}
              >
                {" "}
                <div
                  className="rectanglew5"
            ...
            {Wed6 && (
              <div
                className="overlap-2"
                style={{ height: 37, borderRadius: 0, backgroundColor: BCw6 }}
              >
                {" "}
                <div
                  className="rectanglew6"
            ...
            {Wed7 && (
              <div
                className="overlap-2"
                style={{ height: 37, borderRadius: 0, backgroundColor: BCw7 }}
              >
                {" "}
                <div
                  className="rectanglew6"
            ...
            {Wed8 && (
              <div
                className="overlap-2"
                style={{ height: 37, borderRadius: 0, backgroundColor: BCw8 }}
              >
                {" "}
                <div
                  className="rectanglew6"
